...
const HireMe = () => {
    return (
        ...
        md:right-8 sm:right-0 md:left-auto md:top-0 md:bottom-auto md:absolute z-20">
            <div className="w-48 h-auto items-center justify-center relative md:w-24">
                <CircularText className={'fill-dark animate-spin-slow dark:fill-light'} />
                <Link href="mailto:ayodejiosayemi928@gmail.com" className="flex items-center justify-center absolute 
